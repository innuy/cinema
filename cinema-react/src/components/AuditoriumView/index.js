...
class AuditoriumView extends Component {
    ...
    renderAuditoriums(){
        ...
        for(let i = 0; i < this.props.auditoriums.length; i++){
            result.push(<AuditoriumElement key={"auditorium_"+i} auditorium={this.props.auditoriums[i]} deleteAuditorium={this.props.deleteAuditorium} isAdmin={this.props.isAdmin}/>);
        }
